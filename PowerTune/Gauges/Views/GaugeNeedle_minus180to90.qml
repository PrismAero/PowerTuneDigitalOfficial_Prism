...
Item {
    ...
    onValueChanged: {zeiger.rotation = Math.min(Math.max(-250, root.value*3.5 - 180), 90); root.currentValue = zeiger.rotation - 180} //130 minrotation, -30 maxrotation
    width: parent.width;
    ...
    Rectangle {
        ...
        antialiasing: true
        color: "white"
        onRotationChanged: {root.currentValue = zeiger.rotation - 180; trailEffect.update()}
