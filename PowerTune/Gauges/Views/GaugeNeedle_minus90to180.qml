...
Item {
    ...
    onValueChanged: {
        zeiger.rotation = Math.min(Math.max(-250, root.value * 3.5 - 90), 180);
        root.currentValue = zeiger.rotation - 270;
    }
    width: parent.width
    ...
    Rectangle {
        ...
        antialiasing: true
        color: "white"
        onRotationChanged: root.currentValue = zeiger.rotation - 270
