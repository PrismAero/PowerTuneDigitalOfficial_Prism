            ...
            ComboBox {
                ...
                onCurrentIndexChanged: {
                    ...
                    if (Qt.platform.os === "linux") {
                        backroundpicturesource2 = "file:///home/pi/Logo/" + selectedFile;
                    } else if (Qt.platform.os === "osx") {
                        backroundpicturesource2 = "qrc:/Resources/graphics/" + selectedFile;
                    } else if (Qt.platform.os === "windows") {
                        backroundpicturesource2 = "file:///c:/Logo/" + selectedFile;
                    } else {
                        backroundpicturesource2 = "file:" + selectedFile;
                    }
