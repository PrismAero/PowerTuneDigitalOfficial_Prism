...
QtObject {
    ...
    readonly property var _propertyKeys: ({
        ...
        "Numeric cell": [
            ...
            "unittext", "labeltext", "labelColor", "valueColor", "unitColor"
        ],
        "Gear indicator": [
            "width", "height", "x", "y", "mainvaluename",
        ...
        "Modern round gauge": [
            ...
            "warnvaluehigh", "warnvaluelow", "decimalpoints",
            "unittext", "labeltext", "startangle", "endangle",
            "tickcount", "minortickcount", "dangerStart",
            "arcTrackColor", "arcFillColor", "arcDangerColor",
            "needleColor", "needleGlowColor", "textColor", "labelColor",
            "unitColor", "tickColor"
        ]
    })
    ...
    function serializeGaugeForCSV(gauge) {
        ...
        case "Numeric cell":
            parts.push(gauge.width, gauge.height, gauge.x, gauge.y,
                       ...
                       gauge.decimalpoints, gauge.unittext, gauge.labeltext,
                       gauge.labelColor, gauge.valueColor, gauge.unitColor);
            break;
        case "Gear indicator":
            parts.push(gauge.width, gauge.height, gauge.x, gauge.y,
                       gauge.mainvaluename, gauge.textColor, gauge.labelColor);
            break;
        case "Modern round gauge":
            parts.push(gauge.width, gauge.height, gauge.x, gauge.y,
                       gauge.mainvaluename, gauge.maxvalue, gauge.minvalue,
                       gauge.warnvaluehigh, gauge.warnvaluelow, gauge.decimalpoints,
                       gauge.unittext, gauge.labeltext,
                       gauge.startangle, gauge.endangle,
                       gauge.tickcount, gauge.minortickcount, gauge.dangerStart,
                       gauge.arcTrackColor, gauge.arcFillColor, gauge.arcDangerColor,
                       gauge.needleColor, gauge.needleGlowColor,
                       gauge.textColor, gauge.labelColor,
                       gauge.unitColor, gauge.tickColor);
            break;
        }
        return parts.join(",");
    }
    ...
    function deserializeCSVLine(csvLine, parent) {
        ...
        case "Numeric cell":
            props = {
                "width": parts[1], "height": parts[2], "x": parts[3], "y": parts[4],
                "mainvaluename": parts[5], "warnvaluehigh": parts[6],
                "warnvaluelow": parts[7], "decimalpoints": parts[8],
                "unittext": parts[9], "labeltext": parts[10],
                "labelColor": parts[11], "valueColor": parts[12], "unitColor": parts[13]
            };
            break;
        case "Gear indicator":
            props = {
                "width": parts[1], "height": parts[2], "x": parts[3], "y": parts[4],
                "mainvaluename": parts[5], "textColor": parts[6], "labelColor": parts[7]
            };
            break;
        case "Modern round gauge":
            props = {
                ...
                "startangle": parts[13], "endangle": parts[14],
                "tickcount": parts[15], "minortickcount": parts[16],
                "dangerStart": parts[17], "arcTrackColor": parts[18],
                "arcFillColor": parts[19], "arcDangerColor": parts[20],
                "needleColor": parts[21], "needleGlowColor": parts[22],
                "textColor": parts[23], "labelColor": parts[24],
                "unitColor": parts[25], "tickColor": parts[26]
            };
            break;
        }
        return createGauge(typeName, parent, props);
