...
ColumnLayout {
    ...
    RowLayout {
        ...
        NumericStepper {
            ...
            stepSize: 1
            onValueChanged: function(v) { if (root.target) root.target.minvalue = v; }
        }
    }
    ...
    RowLayout {
        ...
        NumericStepper {
            ...
            stepSize: 10
            onValueChanged: function(v) { if (root.target) root.target.maxvalue = v; }
        }
    }
    ...
    RowLayout {
        ...
        NumericStepper {
            ...
            minValue: 0
            maxValue: 6
            onValueChanged: function(v) { if (root.target) root.target.decimalpoints = Math.round(v); }
        }
    }
    ...
    RowLayout {
        ...
        NumericStepper {
            ...
            stepSize: 100
            onValueChanged: function(v) { if (root.target) root.target.warnvaluehigh = v; }
        }
    }
    ...
    RowLayout {
        ...
        NumericStepper {
            ...
            stepSize: 100
            onValueChanged: function(v) { if (root.target) root.target.warnvaluelow = v; }
        }
    }
}
