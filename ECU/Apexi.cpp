...
static QString mapFD3S[] = {
    "InjDuty", "IGL",  "IGT",  "Rpm",  "Speed", "Boost", "Knock", "WtrTemp", "AirTemp", "BatVolt",
    "PIM",     "VTA1", "VTA2", "VMOP", "WTRT",  "AIRT",  "FUEL",  "O2S",     "STR",     "A/C",
    "PWS",     "NTR",  "CLT",  "STP",  "CAT",   "ELD",   "HWL"};  //	FPD	FPR	APR	PAC	CCN	TCN	PRC	AN1 raw	AN2 raw	AN3
                                                                  // raw	AN4 raw	AN1-AN2 Wide Band	AN2 raw	AN3 raw
                                                                  // AN4 raw	MAPN	MAPP	RPM	PIM	PIM V	TPS V
                                                                  // InjFrPr Inj +/-	IGL	IGT	FuelT	Oil	PC%	WG%	WtrT
                                                                  // AirT Knock	BatV	Speed	???(2)	O2S	???	InjFrSc
/*{"rpm", "pim", "pimV",
