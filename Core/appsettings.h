...
public:
    ...
    Q_INVOKABLE void writeWarnGearSettings(const qreal &waterwarn, const qreal &boostwarn, const qreal &rpmwarn,
    ...
    Q_INVOKABLE void writeAnalogSettings(const qreal &A00, const qreal &A05, const qreal &A10, const qreal &A15,
    ...
    Q_INVOKABLE void writeRPMSettings(const int &mxrpm, const int &shift1, const int &shift2, const int &shift3,
                                      const int &shift4);
    Q_INVOKABLE void
    writeEXBoardSettings(const qreal &EXA00, const qreal &EXA05, const qreal &EXA10, const qreal &EXA15,
    ...
    Q_INVOKABLE void writeSteinhartSettings(const qreal &T01, const qreal &T02, const qreal &T03, const qreal &R01,
